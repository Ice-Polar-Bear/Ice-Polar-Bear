            ...
            <div class="blog-list">
                ...
                <c:forEach items="${blogs}" var="blog" begin="0" end="5">
                    ...
                    <div class="blog-content">
                        ...
                        <div class="content">
                            ${blog.content}
                                ...<a href="blog?id=${blog.id}" class="read">阅读全文</a>

                        </div>
                        <div class="blog-category">
                            <ul>
                                <li><i class="glyphicon glyphicon-user"></i> 写死的数据</li>
                                ...
                                <li><i class="glyphicon glyphicon-calendar"></i><fmt:formatDate value="${blog.createTime}" type="both"/></li>
        ...
        <div class="other">
            <div class="other-list">
                <div class="other-item">
                    <h4><i class="glyphicon glyphicon-user"></i>网页声明</h4><hr>
                    <p>学习用途的网站</p>
                    <p>就业实习练手项目</p>
                    <p>套用了公开模板，严禁商业用途</p>
                    <p>求职意向：java实习</p>
